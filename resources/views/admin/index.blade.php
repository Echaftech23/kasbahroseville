...
@section('contents')
    ...
    <section class="statistics-section">
        <div class="container mx-auto px-6">
        <div
            class="mt-4 grid grid-cols-12 gap-6 transition-all duration-[.25s] sm:gap-5 lg:gap-6"
        >
            ...
            <div class="mt-3 grid grid-cols-12">
                ...
                <div class="bg-white mt-6 pt-8 rounded-[4px] border">
                    ...
                    <small class="text-xs text-gray-600"
                        >In last 30 days revenue from rent.</small
                    >
                    </div>
                    ...
                    class="col-span-12 sm:col-span-6 sm:px-5 lg:col-span-6"
                    ></div>
                </div>
                </div>

                <div
                class="bg-white mt-6 col-span-12 px-6 sm:col-span-6 lg:col-span-6 rounded-[4px] border"
                >
                <div
                    class="card-header flex items-center justify-between pt-8"
                >
                    <h2
                    class="text-sm+ font-medium tracking-wide text-slate-700 dark:text-navy-100"
                    >
                ...
                <div
                    class="flex flex-col justify-center items-center h-[340px] pb-10 sm:pb-0"
                >
                    <div id="hs-bubble-chart"></div>

                    <!-- Legend Indicator -->
                    <div
                    class="flex justify-center sm:justify-end items-center gap-x-4"
                    >
                    <div class="inline-flex items-center">
                        <span
                        class="size-2.5 inline-block bg-blue-600 rounded-sm me-2"
                        ></span>
                        <span
                    ...
                    <div class="inline-flex items-center">
                        <span
                        class="size-2.5 inline-block bg-cyan-500 rounded-sm me-2"
                        ></span>
                        <span
                        class="text-[13px] text-gray-600 dark:text-neutral-400"
                        >
                    ...
                    <div class="inline-flex items-center">
                        <span
                        class="size-2.5 inline-block bg-yellow-300 rounded-sm me-2"
                        ></span>
                        <span
                        class="text-[13px] text-gray-600 dark:text-yellow-400"
                        >
                        Suit
                        </span>
                    </div>
        ...
        >
            ...
            <div class="mt-3 flex items-center justify-between">
                ...
                <small class="text-xs text-gray-600"
                    >How was your income and Expenses this month.</small
                >
                </div>
                ...
                <!-- Legend Indicator -->
                <div
                    class="hidden sm:flex justify-center sm:justify-end items-center gap-x-4 mb-3 sm:mb-6"
                >
                    ...
                    <div class="inline-flex items-center">
                    <span
                        class="size-2.5 inline-block bg-purple-600 rounded-sm me-2"
                    ></span>
                    <span
                        class="text-[13px] text-gray-600 dark:text-neutral-400"
                    >
            ...
            <div class="mt-3 grid grid-cols-12">
                <div
                class="col-span-12 px-4 sm:col-span-6 sm:px-5 lg:col-span-4"
                >
