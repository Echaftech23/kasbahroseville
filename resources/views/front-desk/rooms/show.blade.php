        ...
        <div class="rounded-t-[4px] border bg-white">
            ...
            <div class="px-5 py-5 justify-between border-b-[0.7px] grid lg:grid-cols-3 md:grid-cols-2 gap-4">
                <div class="mt-2 sm:col-span-2 lg:col-span-3">
                    <label class="block text-sm pb-2 font-semibold text-[#344357]">Upload Room Images</label>
                    <div class="flex flex-col">
                        <div id="drop-zone"
                            ...
                            <div class="flex items-center pl-1 overflow-x-scroll sm:overflow-hidden">
                                <div id="selected-images" class="flex flex-none">
                                    @foreach ($images as $image)
                                        <img src="{{ $image->getUrl() }}" class="w-32 mr-3 h-24 object-cover rounded-lg"
                                            alt="Room image">
                                    @endforeach
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ $room->name }}" placeholder="Enter Name" disabled
                        class="w-full mt-1.5 text-[13px] outline-none rounded-[6px] border border-slate-300 bg-white px-3 py-2 hover:border-slate-400" />
                </div>

                <div>
                    <label class="block text-sm font-semibold text-[#344357]">Room Type</label>
                    <input type="text" name="name" value="{{ $room->type->type }}" placeholder="Enter Name" disabled
                        class="w-full mt-1.5 text-[13px] outline-none rounded-[6px] border border-slate-300 bg-white px-3 py-2 hover:border-slate-400" />
                </div>

                <div>
                    <label class="block text-sm font-semibold text-[#344357]">Room Statut</label>
                    <input type="text" name="name" value="{{ $room->statut }}" disabled
                        class="w-full mt-1.5 text-[13px] outline-none rounded-[6px] border border-slate-300 bg-white px-3 py-2 hover:border-slate-400" />
                </div>

                <div>
                    <label class="block text-sm font-semibold text-[#344357]">Room Priority</label>
                    <input type="text" value="{{ $room->priority }}" disabled
                        class="w-full mt-1.5 text-[13px] outline-none rounded-[6px] border border-slate-300 bg-white px-3 py-2 hover:border-slate-400" />
                </div>

                <div>
                    <label class="block text-sm font-semibold text-[#344357]">Room Price</label>
                    <input type="text" value="{{ $room->price }}" disabled
                        class="w-full mt-1.5 text-[13px] outline-none rounded-[6px] border border-slate-300 bg-white px-3 py-2 hover:border-slate-400" />
                </div>

                <div>
                    <label class="block text-sm font-semibold text-[#344357]">Room Capacity</label>
                    <input type="text" name="name" value="{{ $room->capacity }}" disabled
                        class="w-full mt-1.5 text-[13px] outline-none rounded-[6px] border border-slate-300 bg-white px-3 py-2 hover:border-slate-400" />
                </div>
                ...
                <div>
                    ...
                    <div class="relative w-full mt-1.5  inline-block" x-data="{ open: false }" @click.away="open = false">
                        <div>
                            <button type="button"
                        ...
                        <div class="absolute right-0 z-10 mt-2 w-full h-full  origin-top-right rounded-md bg-white shadow-lg  ring-black ring-opacity-5 focus:outline-none"
                            role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1"
                            x-show="open">
                            <div class="py-1" role="none">
                                <select multiple name="facility_id[]"
                ...
                <div>
                    <label class="block text-sm font-semibold text-[#344357]">Room Size</label>
                    <input type="text" value="{{ $room->size }}" disabled
                        class="w-full mt-1.5 text-[13px] outline-none rounded-[6px] border border-slate-300 bg-white px-3 py-2 hover:border-slate-400" />
                </div>
