                ...
                <div
                    ...
                    <div class="relative inline-block text-left mr-1" x-data="{ open: false }" @click.away="open = false">
                        ...
                        <div class="absolute right-0 z-10 mt-2 w-[135px] origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                            ...
                            <form action="{{ route('front-desk.reservations.filter') }}" method="POST">
                                @csrf
                    ...
                    <div class="flex hidden-area">
                        <div class="flex items-center">
                            <div class="relative mx-4 lg:mx-0">
                                <form action="{{ route('front-desk.reservations.search') }}" method="POST" id="searchForm">
                                                        ...
                                                        <div class="absolute right-0 z-10 mt-2 w-24 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                                            ...
                                                            <div class="py-1" role="none">
                                                                <button type="button"
                                                                    class="text-gray-700 block px-4 py-2 text-[13px]"
                                                                    role="menuitem" tabindex="-1" id="menu-item-0"
                                                                    onclick="document.getElementById('paymentStatut').value = 'Completed'"
                                                                    @click="open = !open">Completed</button>
                                                                                        ...
                                                                                        <div class="pb-4 sm:py-6 sm:pb-4">
                                                                                            ...
                                                                                            <div class="mt-2">
                                                                                                <form
                                                                                                    ...
                                                                                                    action="{{ route('front-desk.reservations.update', $reservation) }}"
                                                                                                    method="POST">
                                                                                                    @csrf
                                                                                                    @method('PUT')
                                                                                                    <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <form
                                                                                            ...
                                                                                            action="{{ route('front-desk.reservations.destroy', $reservation) }}"
                                                                                            method="POST">
                                                                                            @csrf
                                                                                            @method('DELETE')
