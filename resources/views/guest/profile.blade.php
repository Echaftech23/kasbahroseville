...
@section('contents')
            ...
            <div class="flex h-full items-center">
                <div class="w-full">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title pb-2">Your Profile Details</h2>
    ...
    <section class="container section-padding-100-0 mb-28 mx-auto px-6 section-margin-20">
        <div class="rounded-[4px] bg-white">
            <div class="shadow-xl pb-5 rounded-[4px] text-gray-900">
                ...
                <div class="mx-6 mt-10">
                    ...
                    <div class="mt-3 card-body">
                        ...
                        <div class="flex items-center mt-2">
                            ...
                            <span class="text-gray-500">{{ Auth::user()->phone ? Auth::user()->phone : '000-0000-000'  }}</span>
                        </div>
                        ...
                        <div class="flex items-center mt-2">
                            ...
                            <span class="text-gray-500">{{ Auth::user()->created_at->format('d M Y H:i:s') }}</span>
                        </div>
                        ...
                        <div class="flex justify-end mt-2">
                            <div class="flex justify-between items-center">
                                <div x-data="{
                                    ...
                                    submitForm: function() {
                                        if (this.statut) {
                                            let form = document.querySelector('#guest-form-' + {{ Auth::user()->id }});
                                            form.submit();
                                        }
                                    }
                                }">
                                    <!-- Button trigger modal -->
                                    <a @click="open = true, statut = '{{ Auth::user()->statut }}'"
                                    ...
                                    <div x-show="open" x-cloak style="display: none;"
                                        ...
                                        <div
                                            ...
                                            <div class="pb-4 sm:py-6 sm:pb-4">
                                                ...
                                                <div class="mt-2">
                                                    <form id="guest-form-{{ Auth::user()->id }}"
                                                        @submit.prevent="submitForm"
                                                        action="{{ route('guest.updateProfile', Auth::user()->id) }}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="border-t px-6 py-4">
                                                            <div class="">
                                                                <label for="name-{{ Auth::user()->name }}"
                                                                    class="block text-sm mt-3 font-medium text-gray-700">
                                                                    Name
                                                                </label>
                                                                <input type="text" id="name-{{ Auth::user()->name }}"
                                                                    name="name"
                                                                ...
                                                                <input type="text" id="phone-{{ Auth::user()->phone }}"
                                                                    name="phone" placeholder="000-0000-000"
                                                                    class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                ...
                <main class="mx-8 my-8 pt-10 border-t rounded-md pb-12 sm:pb-24 px-[30px]">
                                ...
                                <div class="flex grow flex-col px-4 pb-5 pt-1 text-center sm:px-5">
                                    ...
                                    <div class="my-2 flex items-center space-x-3 text-xs">
                                        ...
                                        <p class="shrink-0 font-bold text-sm text-pink-600">
                                            {{ date('F j, Y', strtotime($reservation->created_at->format("d M Y"))) }}</p>
                                        <div class="h-px flex-1 bg-slate-200 dark:bg-navy-500"></div>
                                    </div>
                    ...
                    @endif
                    <nav class="grid-cols-3 w-fit mt-50 bg-white rounded-lg" data-wow-delay="1000ms"
