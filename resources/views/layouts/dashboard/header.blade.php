<!-- header -->
<header
    class="fixed top-0  z-10 headeer-full sm:w-full lg:w-[80%] flex items-center justify-between px-6 py-4 bg-white border-b-2 border-pink-600"
>
    ...
    <div x-data="{ dropdownOpen: false }" class="relative">
        ...
        <span class="text-sm font-medium mobile md:block cursor-pointer"
            >Rachid Echafai</span
        >
        </button>
        <div
